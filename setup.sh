...
iptables -t nat -A POSTROUTING -p tcp --dport 1:65535 -j SNAT --to-source $(hostname -I) -d homelab
iptables -t nat -A POSTROUTING -p udp --dport 1:65535 -j SNAT --to-source $(hostname -I) -d homelab
